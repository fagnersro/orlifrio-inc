...
function GlobeCanvas() {
  ...
  return (
    <div className="absolute -right-72 top-40 z-10 transition-transform group-hover:scale-[1.01] sm:top-12 lg:-right-60 lg:top-0">
      <canvas
        ref={canvasRef}
...
export default function Example() {
  return (
    <>
      <div className="w-full max-w-6xl px-3 py-8 sm:py-20 border-2">
