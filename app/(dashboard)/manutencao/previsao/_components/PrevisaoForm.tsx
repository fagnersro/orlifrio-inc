...
import {
  ...
  TECHS_LIST,
  type Attendee,
} from "@/app/(dashboard)/stores/[slug]/store-data"
...
// Avatar / AvatarStack locais — replicam o visual do ScheduleCard
...
export function PrevisaoForm({ initialEvents }: PrevisaoFormProps) {
  ...
  const handleDelete = (event: MaintenanceEventRow) => {
    ...
    startTransition(async () => {
      ...
      if (result.ok) {
        // Se a row deletada era a que estava em edição, sai do modo edição.
